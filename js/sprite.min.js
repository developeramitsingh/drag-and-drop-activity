...
var spriteOBJ = {
	 parentDiv: "main", // id of div in which animation will be added
	 
	 animTop:80, // animation top position
	 animLeft:270, // animation left position
	 
	 imagePath: "Assets/images/animation.png", // Path of the sprite sheet
	 
	 animSequence: { // animation sequences
		  ideal: {startRow: 0, startCol: 0, endRow: 0, endCol: 0},
		  right: {startRow: 0, startCol: 0, endRow: 4, endCol: 8},
		  wrong: {startRow: 0, startCol: 0, endRow: 4, endCol: 8},
		  wrong2: {startRow: 7, startCol: 0, endRow: 10, endCol: 8},
		  
		},
		
	 frameW: 193,// Width of frame of the animation in pixels
	 frameH: 309,// Height of frame of the animation in pixels
